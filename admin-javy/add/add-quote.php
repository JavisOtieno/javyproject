...
?>
	...
	<form id="submitQuoteForm" action="../submit/submit-quote.php" method="GET">
...
<div id="messages"></div>
    ...
    margin: 10px 2px;
    margin-left:20px;
    cursor: pointer;" type="submit" value="SUBMIT QUOTE">
...
$("#submitQuoteForm").unbind('submit').bind('submit',function(){
