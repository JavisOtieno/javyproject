...
?>
	...
	<form id="submitJobCardForm" action="../submit/submit-job-card.php" method="GET">
...
<div id="messages"></div>
    ...
    margin: 10px 2px;
    margin-left:20px;
    cursor: pointer;" type="submit" value="SUBMIT JOB CARD">
...
$("#submitJobCardForm").unbind('submit').bind('submit',function(){
