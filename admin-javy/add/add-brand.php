<?php include '../header.php'; 
	...
	echo '<br>';
	echo '<form method="GET" action="../submit/submit-brand.php" id="submitBrandForm">';

    echo '<div class="row"><div class="col-md-6"><div style="margin-left:20px;">';

	echo '<div class="form-group"><label>Brand Name:</label>';
	echo '<input class="form-control" name="brandName" ></input></div>';

	echo '<div class="form-group"><label>Brand Slug:</label>';
	echo '<input class="form-control" name="brandSlug" ></input></div>';

	echo '<div class="form-group"><label>Javytech Id:</label>';
	echo '<input class="form-control" name="javytech_id" ></input></div>';
