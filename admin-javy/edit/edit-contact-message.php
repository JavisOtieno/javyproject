...
$query='SELECT * FROM customer_contact_forms WHERE id='.$id.'';
...
if($row=mysqli_fetch_assoc($query_run)){
	...
	echo '<br>';
	echo '<form method="GET" action="../submit/submit-edit-contact-message.php" id="editContactForm">';
  ...
  echo '<input class="form-control" name="message" value="'.$row['message'].'" readonly></input></div>';
