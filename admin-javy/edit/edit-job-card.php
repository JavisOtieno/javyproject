...
if($row=mysqli_fetch_assoc($query_run)){
	...
	echo '<div class="form-group"><label>Job Card Id:</label>';
  ...
  echo '<input class="form-control" name="productId" value="'.$row['product_id'].'"  hidden ></input></div>';
...
$("#editJobCardForm").unbind('submit').bind('submit',function(){
