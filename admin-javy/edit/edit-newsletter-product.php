...
$query='SELECT * FROM newsletter_products WHERE id='.$id.'';
...
if($row=mysqli_fetch_assoc($query_run)){
	...
	echo '<br>';
	echo '<form method="GET" action="../submit/submit-edit-newsletter-product.php" id="editNewsletterProductForm">';

	echo '<div class="row"><div class="col-md-6"><div style="margin-left:20px;">';

	echo '<div class="form-group"><label>Newsletter Product Id:</label>';
...
while($row_product=mysqli_fetch_assoc($query_run_product_name)){
  $product_name=$row_product['name'];
	...
	echo '<input class="form-control" name="product_name" value="'.$product_name.'" readonly></input></div>';
...
$("#editNewsletterProductForm").unbind('submit').bind('submit',function(){
