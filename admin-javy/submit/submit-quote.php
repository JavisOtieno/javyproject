...
if(isset($_GET['orderNotes'])){
$orderNotes=nl2br(str_replace('-', '', $_GET['orderNotes']));
$orderNotes=addslashes($orderNotes);
}
...
$customerEmail!="NONE")
{
    ...
    $sqlcustomers = "INSERT INTO customers VALUES(NULL,NULL,NULL,'$customerName', '$customerContact', '$customerEmail', '$customerAddress','$dealerID',0,'',$dealDate)";
...
$sql="INSERT INTO `quotes` VALUES(NULL,'$datetimestamp','$datetimestamp','$customerName','$customerPhone','$customerEmail','$customerAddress','$dealerID','$customer_id',404,'$productName','$productPrice')";
...
if($connect->query($sql)){
    ...
    $valid['success'] = true;
    $valid['messages'] = $valid['messages']."Quote Successfully Added"; 
