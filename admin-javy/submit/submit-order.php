...
$sql="INSERT INTO `deals` VALUES(NULL,'$customerName','$customerPhone','$customerEmail','$customerAddress','$orderNotes','$productName','$productPrice',0,0,404,'$dealerID','$customer_id',0,0,0,$date,1)";
...
if($connect->query($sql)){
    ...
    $valid['success'] = true;
    $valid['messages'] = $valid['messages']."Order Successfully Added"; 
