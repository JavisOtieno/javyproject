...
if($type=='offer'){
    //local code
    //$target_dir = "../stock-2/assests/images/offers/";
   $target_dir = "../../store/av-admin/assests/images/offers/"; 
}else{
    $target_dir = "../../store/av-admin/assests/images/product-images/".$category."/".$brand."/";
}
...
// Check file size for product image compression if greater than 100KB
...
// if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
        ...
        if($compress){
            ...
            $d = compress($target_file, $target_file, 90);
        }
