...
while($row=$result->fetch_assoc()){
				...
				$email_sendgrid->addContent("text/plain", "Hello, ".$firstname.". Thank you for signing up on Javy. Click on the following link to confirm your account. http://www.javy.co.ke/confirm-email.php?code=".$validation_code );
