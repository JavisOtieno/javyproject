...
$valid['password_set'] = $customer_password_set;
  ...
  $orderStatus = false;
      ...
      $sql = "INSERT INTO deals VALUES (NULL,'$name', '$phone_number', '$email', '$delivery_details','', '$product_name',$product_price ,$product_profit,$cost, $product_id, '$dealer_id','$customer_id','$supplier_id',4,0, '$orderdate',0)";
0
