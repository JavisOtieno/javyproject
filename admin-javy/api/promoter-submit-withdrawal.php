...
if($_GET) {	
	...
	$withdrawalMethod = $_GET['method']; 
	$revenue = $_GET['earnings']; 



	$sql = "INSERT INTO withdrawals (withdrawal_id, user_id, amount, method, date,status) VALUES (NULL,'$dealer_id','$revenue', '$withdrawalMethod','$date', 0)";
...
$sql_promoter = "SELECT * FROM users WHERE user_id = {$dealer_id}";
...
$subject = 'Withdrawal by: promoter id '.$dealer_id;
...
mail($to, $subject, $message, $headers);
	...
	$valid['success'] = false;
	$valid['messages'] = "Check your details.";
	echo json_encode($valid);
}
