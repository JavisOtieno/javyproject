...
echo '<form method="GET" action="products-list.php" id="linkForm">';
    ...
    echo '<div style="display:inline-block;margin:10px;"><a href="products-list.php?link=https://www.phonestablets.co.ke/search/phone"><button>Phones</button></a></div>';
    echo '<div style="display:inline-block;margin:10px;"><a href="products-list.php?link=https://www.phonestablets.co.ke/search/tablet"><button>Tablets</button></a></div>';
    echo '<div style="display:inline-block;margin:10px;"><a href="products-list.php?link=https://www.phonestablets.co.ke/search/laptop"><button>Laptops</button></a></div>';
    echo '<div style="display:inline-block;margin:10px;"><a href="products-list.php?link=https://www.phonestablets.co.ke/search/tv"><button>TVS</button></a></div>';
    echo '<div style="display:inline-block;margin:10px;"><a href="products-list.php?link=https://www.phonestablets.co.ke/search/theater"><button>Home Theatres</button></a></div>';
...
$setlink = 'https://www.phonestablets.co.ke/search/smartphone';
}
