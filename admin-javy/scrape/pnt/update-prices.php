...
$query4="SELECT * FROM products WHERE link LIKE '%phonestablets%'";
...
$query_products_total=$query2="SELECT * FROM products WHERE category='".$category_received."' AND supplier_id=1 AND link LIKE '%phonestablets%' ORDER BY id DESC";
...
$query_products_total="SELECT * FROM products WHERE category='".$category_received."' AND brand='".$brand_received."' AND supplier_id=1 AND link LIKE '%phonestablets%' ORDER BY id DESC";
$query2=$query_products_total." LIMIT ".$offset_id.",50 ";

}
if ( !isset($_GET['brand']) && !isset($_GET['category']) )
{
$query_products_total="SELECT * FROM products WHERE supplier_id=1 AND link LIKE '%phonestablets%' ORDER BY id DESC";
$query2=$query_products_total." LIMIT ".$offset_id.",50 ";
}
...
if($html->find('span[class="payBlkBig"]',0)){
