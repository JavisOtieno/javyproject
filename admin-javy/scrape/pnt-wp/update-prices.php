...
$query2="SELECT * FROM products WHERE category='".$category_received."' AND link LIKE '%phonestablets%' AND link!='' ORDER BY id DESC LIMIT ".$offset_id.",50 ";
...
$query2="SELECT * FROM products WHERE category='".$category_received."' AND brand='".$brand_received."' AND supplier_id=1 AND link LIKE '%phonestablets%' AND link!='' ORDER BY id DESC LIMIT ".$offset_id.",50 ";

}
if ( !isset($_GET['brand']) && !isset($_GET['category']) )
{
$query2="SELECT * FROM products WHERE supplier_id=1 AND link LIKE '%phonestablets%' AND link!='' ORDER BY id DESC LIMIT ".$offset_id.",50 ";
}
