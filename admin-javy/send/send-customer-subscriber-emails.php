...
$query = 'SELECT * FROM customer_emails WHERE id>'.$count.' AND email NOT IN (SELECT email FROM customers) AND id NOT IN (SELECT id FROM unsubscribe_list_subscribers) LIMIT 11';
//Test purposes Javis
