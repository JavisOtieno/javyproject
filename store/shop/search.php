<?php include 'header.php'; ?>
	...
	if(isset($_GET['page'])){
		...
		if($products_type==0){
			$query_category_brand='SELECT category,brand FROM `products` WHERE supplier_id='.$supplier.' AND status="1" ';
		}else{
			$query_category_brand='SELECT category,brand FROM `products` WHERE (approval="2" OR supplier_id='.$supplier.') AND status="1" ';
		}


		//$query_category_brand='SELECT category,brand FROM `products` WHERE status="1" AND supplier_id='.$supplier.' ';
	...
	<div class="products">	 
		<div class="container">
			...
			if($products_type==0){
				$query="SELECT * FROM `products` WHERE status='1' AND (supplier_id=".$supplier." OR id IN (SELECT product_id FROM more_suppliers WHERE supplier_id=".$supplier.")) ".$search_sql;
			}else{
				$query="SELECT * FROM `products` WHERE status='1' AND ((`approval`='2') OR (`approval`='1' AND (supplier_id=".$supplier." OR id IN (SELECT product_id FROM more_suppliers WHERE supplier_id=".$supplier."))))  ".$search_sql;
			}
			...
			if($products_type==0){
				$query="SELECT * FROM `products` WHERE status='1' AND (supplier_id=".$supplier." OR id IN (SELECT product_id FROM more_suppliers WHERE supplier_id=".$supplier.")) ".$search_sql." LIMIT ".$page1.",20";
			}else{
				$query="SELECT * FROM `products` WHERE status='1' AND ((`approval`='2') OR (`approval`='1' AND supplier_id=".$supplier.") OR id IN (SELECT product_id FROM more_suppliers WHERE supplier_id=".$supplier.")) ".$search_sql." LIMIT ".$page1.",20";
			}
		...
		<!--<div class="related-row">
				...
				<div class="related-row" style="display: none;">
					...
					<div class="galry-like">  
						...
						<h4><a href="product.php?slug=<?php echo $slug; ?>"><?php echo $name; ?></a></h4> 
