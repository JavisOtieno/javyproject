			...
			<div class="single-page">
				<div class="single-page-row" id="detail-21">
					...
					<div class="col-md-6 single-top-right">
						...
						<!--<a href="javascript:void(0);" id="mpopupLink2" style="display: none;">
				...
				<div class="single-page-icons social-icons"> 
					<ul>
						...
						<li><a href="http://www.facebook.com/sharer.php?u=<?php echo $actual_link; ?>" target="_blank" class="fa fa-facebook icon facebook"></a></li>
