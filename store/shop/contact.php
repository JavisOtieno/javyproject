			...
			<div class="contact-form-row">
				...
				<div class="col-md-7 contact-left">
					...
					<div id="submit-contact-messages"></div>
						...
						<input id="phone" class="email" type="text" name="phone" placeholder="Phone number" required="">
						<input id="email" style="width:100%;" type="text" name="email" placeholder="Email" required="">
						<input id="email2" style="width:100%;display: none;" type="text" name="email2" placeholder="Email">
