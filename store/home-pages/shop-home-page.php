	...
	<div class="products">	 
		<div class="container">
			...
			$query='SELECT * FROM `products` WHERE category="'.$category.'" AND approval!="0" AND store_id='.$user_id.' AND brand="'.$brand.'" AND status="1" ORDER BY price';
			}
			else if(isset($_GET['category'])&&!isset($_GET['brand'])){
				$query='SELECT * FROM `products` WHERE category="'.$category.'" AND approval!="0" AND store_id='.$user_id.' AND status="1" ORDER BY price';
			}
			else{
				$query='SELECT * FROM `products` WHERE status="1" AND approval!="0" AND store_id='.$user_id.' ORDER BY category,brand,price';
			}

		}else if($shop_type==4){
			//supplier products
			if(isset($_GET['category'])&&isset($_GET['brand'])){
			$query='SELECT * FROM `products` WHERE category="'.$category.'" AND brand="'.$brand.'" AND (((supplier_id='.$supplier_id.' OR id IN (SELECT product_id FROM more_suppliers WHERE supplier_id='.$supplier_id.'))  AND status="1") OR (status="1" AND approval!="0" AND store_id='.$user_id.')) ORDER BY price';
			}
			else if(isset($_GET['category'])&&!isset($_GET['brand'])){
				$query='SELECT * FROM `products` WHERE category="'.$category.'" AND (((supplier_id='.$supplier_id.' OR id IN (SELECT product_id FROM more_suppliers WHERE supplier_id='.$supplier_id.')) AND status="1") OR (status="1" AND approval!="0" AND store_id='.$user_id.')) ORDER BY price';
			}
			else{
				$query='SELECT * FROM `products` WHERE ((status="1" AND (supplier_id='.$supplier_id.' OR id IN (SELECT product_id FROM more_suppliers WHERE supplier_id='.$supplier_id.'))) OR (status="1" AND approval!="0" AND store_id='.$user_id.')) ORDER BY category,brand,price';
			}

		}else{

			if (isset($_GET['category'])&&isset($_GET['brand'])){
			$query='SELECT * FROM `products` WHERE (approval="2" OR (approval="1" AND store_id='.$user_id.')) AND status="1" AND category="'.$category.'" AND brand="'.$brand.'" ORDER BY price';
			}
			else if(isset($_GET['category'])&&!isset($_GET['brand'])){
				$query='SELECT * FROM `products` WHERE (approval="2" OR (approval="1" AND store_id='.$user_id.')) AND status="1" AND category="'.$category.'" ORDER BY price';
			}
			else{
				$query='SELECT * FROM `products` WHERE (approval="2" OR (approval="1" AND store_id='.$user_id.')) AND status="1" ORDER BY category,brand,price';
			}
...
<a href="index.php<?php if(isset($category)){echo '?category='.$category;} if(isset($_GET['brand'])){echo '&brand='.$brand; }?><?php if(isset($category)){echo '&page=';}else {echo '?page=';} ?><?php echo $page-1;  ?>" <?php if($page==1){ echo 'style="display: none;"';} ?>>&laquo; Previous</a>
  ...
  <a href="index.php<?php if(isset($category)){echo '?category='.$category;} if(isset($_GET['brand'])){echo '&brand='.$brand; } ?><?php if(isset($category)){echo '&page=';}else {echo '?page=';} ?><?php echo $page+1;  ?>" <?php if($page==$pages){ echo 'style="display: none;"';} ?>>&raquo; Next</a>
			...
			<div class="col-md-3 rsidebar">
						...
						<ul class="faq">
							...
							while($row=mysqli_fetch_assoc($query_run_categories)){
								...
								if($shop_type==1){
									...
									$query_check_category=$query='SELECT * FROM `products` WHERE status="1" AND (approval="2" OR (approval="1" AND store_id='.$user_id.')) AND category="'.$category_slug.'"';
								}
								...
								if($shop_type==1){
									...
									$query_check_brand=$query='SELECT * FROM `products` WHERE status="1" AND (approval="2" OR (approval="1" AND store_id='.$user_id.')) AND brand="'.$brand_slug.'"';
								}
				...
				//get single product
				$query='SELECT * FROM `products` WHERE  ( approval="1" AND status="1" )  AND store_id='.$user_id.' ORDER BY category,brand,price LIMIT 1';
								$query_run=mysqli_query($db_link,$query);
								$count=1;
