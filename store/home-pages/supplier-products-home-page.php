						...
						function showProduct($image,$name,$price,$id,$count)
			{
				...
				echo '	<div class="col-md-3 product-grids" > 
						<div class="agile-products" >
							...
							<a href="product.php?id='.$id.'"><img src="'.$image.'" class="img-responsive img-match-height" style="height: 100%; width: 100%; object-fit: contain" alt="img"></a>
  ...
  <a href="index.php<?php if(isset($category)){echo '?category='.$category;} if(isset($_GET['brand'])){echo '&brand='.$brand; } ?><?php if(isset($category)){echo '&page=';}else {echo '?page=';} ?><?php echo $page+1;  ?>" <?php if($page==$pages){ echo 'style="display: none;"';} ?>>&raquo; Next</a>
			...
			<div class="col-md-3 rsidebar">
			 ...
			 echo '<li class="item1"><a href="#">'.ucfirst($category).'<span class="glyphicon glyphicon-menu-down"></span></a>
								<ul>
									<li class="subitem1"><a href="index.php?category='.$category.'">All '.ucfirst($category).'</a></li>';

			


			foreach($brand_array as $brand) {
				echo '<li class="subitem1"><a href="index.php?category='.$category.'&brand='.$brand.'">'.ucfirst($brand).'</a></li>';
			}
			 ...
			 echo '</ul>
				...
				if($row['image']==''){
					...
					<div class="galry-like">  
						<a href="product.php?id='.$id.'"><img src="'.$image_uri.'" class="img-responsive" alt="img"></a>             
