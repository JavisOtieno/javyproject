	...
	<div class="banner">
		<div id="kb" class="carousel kb_elastic animate_text kb_wrapper" data-ride="carousel" data-interval="6000" data-pause="hover">
            ...
            <div class="carousel-inner" role="listbox">  
                ...
                <a href="shop.php?category=mens-fashion">
                    <img src="images/mens-fashion-banner.jpg" alt="" class="img-responsive" />
                    <div class="carousel-caption kb_caption kb_caption_right">
                        <h3 data-animation="animated flipInX">Mens <span>Fashion</span> Available</h3>
                ...
                <div class="item">  
                 <a href="shop.php?category=womens-fashion">
                    <img src="images/womens-fashion-banner.jpg" alt="" class="img-responsive" />
                    <div class="carousel-caption kb_caption kb_caption_right">
                        <h3 data-animation="animated fadeInDown">Ladies bags and more</h3>
		...
		<div class="container"> 
						...
						<div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
							<div class="tabcontent-grids">  
								<div id="owl-demo" class="owl-carousel"> 
									...
									displayFeaturedProducts("womens-fashion",$db_link);
			...
			?>
							...
							<div class="tabcontent-grids">
								...
								displayFeaturedProducts("mens-fashion",$db_link);
						...
						<div role="tabpanel" class="tab-pane fade" id="decor" aria-labelledby="decor-tab">
							...
							<?php
								...
								$query='SELECT * FROM `products` WHERE status="1" AND (approval="2" OR (approval="1" AND store_id='.$user_id.') OR supplier_id="'.$supplier_id.'" OR id IN (SELECT product_id FROM more_suppliers WHERE supplier_id='.$supplier_id.')) AND category IN ("tvs","home-theatres") ORDER BY id DESC LIMIT 8';
								$query_run=mysqli_query($db_link,$query);
								$count=1;
