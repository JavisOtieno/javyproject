...
if($_POST) {
  ...
  */
  ...
  $productProfit=$row[1]; 
	...
	$sql = "UPDATE deals SET name = '$clientName', phone = '$clientContact', email='$clientEmail', delivery_details='$clientDeliveryDetails',product_name='$productName',product_profit='$productProfit', product_id='$productId', status='$status' WHERE id = {$orderId}";	
	$connect->query($sql);
