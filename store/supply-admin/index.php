...
if($_POST) {		
	...
	if(empty($username) || empty($password)) {
		...
		if($result->num_rows > 0) {
			...
			if($email_entered){
				$errors[] = "Incorrect Email. Please check your email and try again".$sql;
			}else{
	...
	<div class="container">
		<div class="col-md-5 col-md-offset-4" style="margin-top: 40px">
			...
			if ($host=='supply.javy.co.ke'){
				echo '<a href="https://www.javy.co.ke/supply-us.php"><img src="assests/images/javy-supply-learn-more.jpg"></a>';
			}
			else{
				echo '<h1><a href=https://'.$host.' style="display: inline-block;color: #000;text-decoration: none;position: relative;font-weight: 700;" >Back to <span style="font-size: 1.7em;color: #F44336;vertical-align: sub;margin-right: 3px;">'.strtoupper(substr($storename, 0, 1)).'</span>'.substr($storename,1,mb_strlen($storename)-1).'</a></h1>';
			...
			<div class="col-md-5 col-md-offset-4">
				<div class="panel panel-info">
					<div class="panel-heading">
						<h3 class="panel-title">Supply : Please Sign in</h3>
					</div>
