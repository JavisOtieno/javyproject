...
$query_users='SELECT * FROM suppliers WHERE username="'.$username.'"';
...
$query_unsubscribe='SELECT * FROM unsubscribe_list_suppliers WHERE id='.$id;
...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        ...
        $sql ="DELETE FROM unsubscribe_list_suppliers WHERE id=".$id;
 ...
 if($rows_unsubscribe==0){
        ...
        $sql ="INSERT INTO unsubscribe_list_suppliers VALUES(NULL,$id)";


         if($connect->query($sql)){
        echo "<h3 style='text-align: center;'> You have been unsubscribed. You will no longer receive our emails.</h3>";

        echo '<h5>Changed your mind? <a href="unsubscribe.php?username='.$username.'&subscribe=true">Click here to subscribe and receive our emails</a></h5>';
