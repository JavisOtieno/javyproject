...
<div class="banner_inner_content_agile_w3l">
	...
	<div class="about">
		<div class="container">
			<h3 class="heading-agileinfo">What We Do<span></span></h3>
			<div class="col-md-6 about-w3right">
				<img src="images-front/g14.png" class="img-responsive" alt="" />
			</div>
			<div class="col-md-6 about-w3left">
					...
					<div class="panel panel-default">
							...
							<div class="panel-body panel_text">
								We provide regular people with the chance to open up their own online business and make money by marketing. We provide the products and a website.<br/><br/>

								Once they open up their websites, they become promoters. They market their websites to sell the products to customers. We'll handle the delivery of the products to customers.<br/><br/>

								Once the customers receive and pay for the products, the promoters withdraw the money from their account into Mpesa, Airtel money or as cash.
							</div>
	...
	<div class="container">
		...
		<div class="teamgrids">
			<div class="col-md-3 teamgrid1">
				<img src="images-front/t1.jpg" class="img-responsive" alt="" />
				<div class="teaminfo">
					<h3>Frankline</h3>
			...
			<div class="col-md-3 teamgrid1">
				<img src="images-front/t2.jpg" class="img-responsive" alt="" />
				<div class="teaminfo">
					<h3>Guptill</h3>
					<div class="team-social">
						<a href="#"><i class="fa fa-facebook"></i></a>
			...
			<div class="col-md-3 teamgrid1">
				<img src="images-front/t3.jpg" class="img-responsive" alt="" />
				<div class="teaminfo">
					<h3>Mitchel</h3>
					<div class="team-social">
						<a href="#"><i class="fa fa-facebook"></i></a>
			...
			<div class="col-md-3 teamgrid1">
				<img src="images-front/t4.jpg" class="img-responsive" alt="" />
				<div class="teaminfo">
					<h3>John Paul</h3>
					<div class="team-social">
						<a href="#"><i class="fa fa-facebook"></i></a>
