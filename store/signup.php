		...
		<div class="container"> 
			...
			<div class="login-body">
				<form action="submit-sign-up.php" method="post" id="signupForm">
					...
					<input type="text" class="user" id="email3" name="email3" placeholder="Enter your email" required="">
					<input type="text" style="display: none;" class="user" id="email4" name="email4" placeholder="Enter your second email">
					<input type="text" class="user" id="address" name="address" placeholder="Enter your delivery details (Location details)">
...
$("#signupForm").unbind('submit').bind('submit',function(){
		...
		*/
			...
			//prevent spam attacks on websites
