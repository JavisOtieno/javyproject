...
require($base."/store/email-sendgrid/sendgrid-php.php");

require $base.'/store/connect.inc.php';
...
$query='SELECT * FROM users WHERE user_id='.$user_id.' AND user_id NOT IN (SELECT user_id FROM unsubscribe_list)';
...
while($row=mysqli_fetch_assoc($query_run))
{
			...
			$email_sendgrid->setSubject("Congratulations. You hit ".number_format($website_visits)." website visits on www.".$storename.".av.ke ");
